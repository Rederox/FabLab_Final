...
if ($_POST['appareil'] != '') {
    if ($_FILES['file']['name'] != '') {
        ...
        $sql_insert = "INSERT INTO `NFC_Notices` (`Numero_appareil`, `url`) VALUES ('$numero' , \"192.168.3.83\/Notices\/$appareil.pdf\")";
        if (!file_exists(__DIR__ . $upload_path . $appareil . "." . $fileExt)) {
            ...
            if (move_uploaded_file($tempPath, __DIR__ . $upload_path . $appareil . "." . $fileExt)) {
                ...
                //echo "NON Reussi :(";
                echo $upload_path.$appareil.".".$fileExt;
            }
        }
    } else {
    ...
    echo "Veuillez choisir l'Appareil";
}
