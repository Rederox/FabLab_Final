        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Listes des adhérents</h4>
                  <?php require "PHP/ind.php" ?>
                  <?php DisplayTableDel($pdo); ?>
                  <br>
                  <button type="button" class="btn btn-primary mr-2" onclick="addUser()">Ajouter un adhérent</a></button>
                </div>
              </div>
            </div>
          </div>
