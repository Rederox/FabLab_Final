        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Modifier l'adhérent :</h4>
                  <h4 class="card-title" id="show"></h4>
                  <p class="card-description">Veuillez modifier au moins une donnée avant de valider</p>
                    ...
                    <div class="form-group">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input" name="choix" id="manuelEdit" value="2" checked>Manuel</label>
                          </div>
                        </div>
                      </div>
                    </div>
