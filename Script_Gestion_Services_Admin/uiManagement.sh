...
do		
	...
	case $serviceAnswer in
		...
		"10.Fix")
			...
			sudo cp /home/fablab/serviceManagement/backup/SEP001D70FC2031.cnf.xml /var/lib/tftpboot/

			sudo cp /home/fablab/serviceManagement/backup/SEP001906445169.cnf.xml /var/lib/tftpboot/

			sudo cp /home/fablab/serviceManagement/backup/SEP00260BD7BA88.cnf.xml /var/lib/tftpboot/

			sudo cp /home/fablab/serviceManagement/backup/dhcpd.conf /etc/dhcp/

			sudo cp /home/fablab/serviceManagement/backup/extensions.conf /etc/asterisk/
			sudo cp /home/fablab/serviceManagement/backup/voicemail.conf /etc/asterisk/
			sudo cp /home/fablab/serviceManagement/backup/users.conf /etc/asterisk/
